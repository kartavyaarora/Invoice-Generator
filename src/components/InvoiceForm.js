...
class InvoiceForm extends React.Component {
  ...
  render() {
    ...
    this.setState.invoiceNumber = invoiceList.length+1;
    return (
      <>
      <div className="mt-3">
      <NavLink to='/'>
...
const mapStateToProps = (state) => {
  return {
    invoiceList: state.invoiceReducer.invoiceList, // Assuming invoiceReducer contains invoiceList
  };
};
